...
def get_pet_labels(image_dir):
    ...
    for filename in in_files:
       ...
       if filename[0] != ".":
           ...
           # alphabetic character if true append word
           #  to pet_label sprated by trailing space
           for word in word_list_pet_image:
            if word.isalpha():
               pet_label += word + " "
           
           # strip off starting/trailing whitespace character
